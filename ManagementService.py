...
def management(start_point, start_time, walking_time_period, walking_speed, bus_waiting_time, bus_ride_time,
    ...
    n52_wps_url = 'http://127.0.0.1:8080/52n/WebProcessingService?service=WPS&version=1.0.0&request=execute&identifier='
    ...
    otp_url = n52_wps_url + 'walkyourplace.transit.wps.centralized.Walkshed&datainputs=' + otp_dataInputs
    walkshed_main = urllib2.urlopen(otp_url).read()
    walkshed_main = parseXML(walkshed_main, 'ns:LiteralData')
    ...
    if walkshed_main != '':
        ...
        if walkshed_json['type'] == "Polygon":
            ...
            transit_url = n52_wps_url + 'walkyourplace.transit.wps.centralized.Transit&datainputs=' + transit_dataInputs
            transit_data = urllib2.urlopen(transit_url).read()
            transit_data = parseXML(transit_data, 'ns:LiteralData')
            ...
            if transit_data != '"NULL"':
                ...
                for item in transit_data_json['features']:
                    ...
                    otp_data = parseXML(otp_data, 'ns:LiteralData')
                ...
                union_wps_url = 'http://127.0.0.1:8080/52n/WebProcessingService'
                union_xml_data = """<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<wps:Execute service="WPS" version="1.0.0" xmlns:wps="http://www.opengis.net/wps/1.0.0" xmlns:ows="http://www.opengis.net/ows/1.1" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/wps/1.0.0 http://schemas.opengis.net/wps/1.0.0/wpsExecute_request.xsd">
  <ows:Identifier>walkyourplace.transit.wps.centralized.Union</ows:Identifier>
  <wps:DataInputs>
    <wps:Input>
  ...
  <wps:ResponseDocument>
    <wps:RawDataOutput>
      <ows:Identifier>UnionResult</ows:Identifier>
                ...
                walkshed_union = parseXML(walkshed_union, 'ns:LiteralData')
            ...
            #invoke poi service
            poi_wps_url = 'http://127.0.0.1:8080/52n/WebProcessingService'
            poi_xml_data = """<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<wps:Execute service="WPS" version="1.0.0" xmlns:wps="http://www.opengis.net/wps/1.0.0" xmlns:ows="http://www.opengis.net/ows/1.1" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/wps/1.0.0 http://schemas.opengis.net/wps/1.0.0/wpsExecute_request.xsd">
  <ows:Identifier>walkyourplace.transit.wps.centralized.POI</ows:Identifier>
  <wps:DataInputs>
    <wps:Input>
  ...
  <wps:ResponseDocument>
    <wps:RawDataOutput>
      <ows:Identifier>POIResult</ows:Identifier>
            ...
            poi_data = parseXML(poi_data, 'ns:LiteralData')

            print 'poi data: %s' % (poi_data,)

            #invoke crime wps
            crime_wps_url = 'http://127.0.0.1:8080/52n/WebProcessingService'
            crime_xml_data = """<wps:Execute service="WPS" version="1.0.0" xmlns:wps="http://www.opengis.net/wps/1.0.0" xmlns:ows="http://www.opengis.net/ows/1.1" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/wps/1.0.0 http://schemas.opengis.net/wps/1.0.0/wpsExecute_request.xsd">
  <ows:Identifier>walkyourplace.transit.wps.centralized.Crime</ows:Identifier>
  <wps:DataInputs>
    <wps:Input>
      <ows:Identifier>Walkshed</ows:Identifier>
      <wps:Data>
  ...
  <wps:ResponseDocument>
    <wps:RawDataOutput>
      <ows:Identifier>CrimeResult</ows:Identifier>
            ...
            crime_data = parseXML(crime_data, 'ns:LiteralData')
            ...
            aggregation_wps_url = 'http://127.0.0.1:8080/52n/WebProcessingService'
            aggregation_xml_data = """<wps:Execute service="WPS" version="1.0.0" xmlns:wps="http://www.opengis.net/wps/1.0.0" xmlns:ows="http://www.opengis.net/ows/1.1" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.opengis.net/wps/1.0.0 http://schemas.opengis.net/wps/1.0.0/wpsExecute_request.xsd">
  <ows:Identifier>walkyourplace.transit.wps.centralized.Aggregation</ows:Identifier>
    <wps:DataInputs>
        <wps:Input>
...
<wps:Input>
    ...
    <wps:RawDataOutput>
      <ows:Identifier>AggregationResult</ows:Identifier>
            ...
            aggregation_data = parseXML(aggregation_data, 'ns:LiteralData')
    ...
    #result = '{"walkshed": %s, "poi": %s, "crime": %s, "transit": %s}' % (aggregation_data, poi_data, crime_data, transit_data)
